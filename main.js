...
door.position.set(0, 1, 4.01 / 2);
house.add(door);

// Bushes
const bushGeometery = new THREE.SphereGeometry();
...
for (let i = 0; i < 50; i++) {
	...
	// Logic to generate random number between two given numbers
	//Math.random() * (max - min) + min;
	const y = Math.random() * (0.4 - 0) + 0;
